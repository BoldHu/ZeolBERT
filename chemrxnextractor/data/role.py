                ...
                if line.startswith("#"):
                    ...
                    if words:
                        ...
                        for y in labels_by_prod:
                            assert "B-action" in y # make sure there is a Product
                ...
                if line.startswith("#"):
                    ...
                    if words:
                        ...
                        for etype, ss, se in prods:
                            ...
                            inst_labels[ss] = "B-action"
                            inst_labels[ss+1:se+1] = ["I-action"] * (se-ss)
                            examples.append(
                                InputExample(
                                    guid=f"{guid_index}",
                                    words=words,
...
def convert_examples_to_nospecial_features(
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        for wid, (word, label) in enumerate(
            ...
            elif prod_start_index >= 0 and prod_end_index < 0 and label != "I-action":
